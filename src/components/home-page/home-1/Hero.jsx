        ...
        <div className="row">
          ...
          >
            <h1 className="hero-heading fw-500 tx-dark">
              ...
              <span> books</span> &amp; educational materials.
            </h1>
            <p className="text-lg tx-dark mt-45 mb-50 lg-mt-30 lg-mb-40">
            From an extensive online bookstore to comprehensive educational services, we are committed to supporting your learning journey and child care needs.
            </p>
            {/* <form
            ...
            <div>
              <div className="approval-info d-inline-flex align-items-center mt-130 lg-mt-80">
                ...
                <span>Efficient and reliable services to meet your diverse needs.</span>
              </div>
            </div>
          </div>
        </div>
